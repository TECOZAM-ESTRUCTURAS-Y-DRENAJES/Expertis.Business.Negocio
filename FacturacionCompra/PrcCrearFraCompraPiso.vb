...
Public Class PrcCrearFraCompraPiso
    Inherits Process
    ...
    Public Overrides Sub RegisterTasks()
        ...
        Me.AddTask(Of DocumentoFacturaCompra)(AddressOf ProcesoFacturacionCompra.AsignarContadorPiso)
        ...
        'David Velasco 26/7/22
        Me.AddTask(Of DocumentoFacturaCompra)(AddressOf ProcesoFacturacionCompra.CrearLineasDesdePiso)
        ...
        Me.AddTask(Of DocumentoFacturaCompra)(AddressOf ProcesoFacturacionCompra.CentroCosteEnAnalitica)
