Public Class HistoricoPreciosCliente
...
#Region "Constructor"
    ...
    Private Const cnEntidad As String = "tbHistoricoPreciosCliente"
...
#Region "Eventos Entidad"
    ...
    <Task()> Public Shared Sub ValidarClaveDuplicada(ByVal data As DataRow, ByVal services As ServiceProvider)
        If data.RowState = DataRowState.Added Then
            ...
            Dim DtHist As DataTable = New HistoricoPreciosCliente().Filter(FilHist)
