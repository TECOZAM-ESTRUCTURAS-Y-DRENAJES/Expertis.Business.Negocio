...
#Region "Constructor"
    ...
    Private Const cnEntidad As String = "tbMaestroTipoCliente"
...
#Region "Eventos RegisterValidateTasks"
    ...
    <Task()> Public Shared Sub ValidarDatosObligatorios(ByVal data As DataRow, ByVal services As ServiceProvider)
        If Length(data("IDTipoCliente")) = 0 Then ApplicationService.GenerateError("Tipo de cliente es un dato obligatorio.")
        If Length(data("DescTipoCliente")) = 0 Then ApplicationService.GenerateError("La Descripción es un dato obligatorio.")
    End Sub
    ...
    <Task()> Public Shared Sub ValidarClavePrimaria(ByVal data As DataRow, ByVal services As ServiceProvider)
        If data.RowState = DataRowState.Added Then
            Dim dt As DataTable = New TipoCliente().SelOnPrimaryKey(data("IDTipoCliente"))
