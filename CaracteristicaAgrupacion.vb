...
#Region "Eventos RegisterValidateTasks"
    ...
    <Task()> Public Shared Sub ValidarDatosObligatorios(ByVal data As DataRow, ByVal services As ServiceProvider)
        If Length(data("IDAgrupacion")) = 0 Then ApplicationService.GenerateError("La Agrupación es un dato obligatorio.")
        If Length(data("DescAgrupacion")) = 0 Then ApplicationService.GenerateError("La Descripción es un dato obligatorio.")
    End Sub
