...
#Region "Eventos RegisterValidateTasks"
    ...
    <Task()> Public Shared Sub ValidarDatosObligatorios(ByVal data As DataRow, ByVal services As ServiceProvider)
        If Length(data("DescIdioma")) = 0 Then ApplicationService.GenerateError("Introduzca la descripción del idioma")
    End Sub
    ...
    <Task()> Public Shared Sub ValidarClaveDuplicada(ByVal data As DataRow, ByVal services As ServiceProvider)
        If data.RowState = DataRowState.Added Then
            If Length(data("IDIdioma")) > 0 Then
                ...
                End If
            Else : ApplicationService.GenerateError("Introduzca el código del idioma.")
            End If
        End If
    End Sub
