...
Public Class PrcCrearAlbaranVentaPedidos
    Inherits Process
    ...
    Public Overrides Sub RegisterTasks()
        ...
        Me.AddTask(Of DocumentoAlbaranVenta)(AddressOf ProcesoAlbaranVenta.AsignarDatosCliente)
        Me.AddTask(Of DocumentoAlbaranVenta)(AddressOf ProcesoAlbaranVenta.AsignarDatosEDI)
        ...
        Me.AddTask(Of DocumentoAlbaranVenta)(AddressOf ProcesoComunes.AsignarCentroGestion)
        ...
        Me.AddTask(Of DocumentoAlbaranVenta)(AddressOf ProcesoAlbaranVenta.AsignarDatosTransporte)
        Me.AddTask(Of DocumentoAlbaranVenta)(AddressOf ProcesoAlbaranVentaPedidos.CrearLineasDesdePedido)  'Sin Kits
        ...
        Me.AddTask(Of DocumentoAlbaranVenta)(AddressOf ProcesoAlbaranVentaPedidos.CopiarAnalitica)
        Me.AddTask(Of DocumentoAlbaranVenta)(AddressOf ProcesoAlbaranVentaPedidos.CopiarRepresentantes)
