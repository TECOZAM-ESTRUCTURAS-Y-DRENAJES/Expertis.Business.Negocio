Public Class ProcesoAlbaranVentaAlquiler
...
#Region " AgruparAlquiler "
    ...
    End Function
    'David V 3/3/22
    <Task()> Public Shared Function AgruparAlquiler2(ByVal data As DataPrcAlbaranarDeposito, ByVal services As ServiceProvider) As AlbCabVentaAlquiler()
        Dim IDMaterial(-1) As Object
        Dim htLins As New Hashtable
        For Each AVInfo As CrearAlbaranVentaInfo In data.AlbVentaInfo
            If AVInfo.IDLinea > 0 Then 'IDLineaMaterial o IDLineaAlbaran
