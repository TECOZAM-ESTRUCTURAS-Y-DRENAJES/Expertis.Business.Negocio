'DAVID VELASCO 02/03/22
Public Class PrcActualizarAlbaranAlquilerSinStock
    ...
    Public Overrides Sub RegisterTasks()
        ...
        Me.AddForEachTask(Of DocumentoAlbaranVenta)(AddressOf ActualizarDocumentoAlbaranAlquilerSinStock, OnExceptionBehaviour.NextLoop)
    ...
    End Function
    <Task()> Public Shared Sub ActualizarDocumentoAlbaranAlquilerSinStock(ByVal doc As DocumentoAlbaranVenta, ByVal services As ServiceProvider)
        AdminData.BeginTx()
        ...
        'Comentado para que no haga el movimiento David Velasco
        'ProcessServer.ExecuteTask(Of DocumentoAlbaranVenta)(AddressOf ProcesoAlbaranVenta.ActualizacionAutomaticaStock, doc, services)
