...
#Region "Constructor"
    ...
    Private Const cnEntidad As String = "tbMaestroTipoElemento"
...
#Region "Eventos RegisterValidateTasks"
    ...
    <Task()> Public Shared Sub ValidarDatosObligatorios(ByVal data As DataRow, ByVal services As ServiceProvider)
        If Length(data("IDTipoElemento")) = 0 Then ApplicationService.GenerateError("Tipo de elemento es un dato obligatorio.")
        If Length(data("DescTipoElemento")) = 0 Then ApplicationService.GenerateError("La Descripción es un dato obligatorio.")
    End Sub
    ...
    <Task()> Public Shared Sub ValidarClavePrimaria(ByVal data As DataRow, ByVal services As ServiceProvider)
        If data.RowState = DataRowState.Added Then
            Dim dt As DataTable = New TipoElemento().SelOnPrimaryKey(data("IDTipoElemento"))
