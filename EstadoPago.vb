Public Class EstadoPagoInfo
    ...
    Public Overloads Overrides Sub Fill(ByVal ParamArray PrimaryKey() As Object)
        Dim dt As DataTable = New EstadoPago().SelOnPrimaryKey(PrimaryKey(0))
        If Not IsNothing(dt) AndAlso dt.Rows.Count > 0 Then
            Me.Fill(dt.Rows(0))
        Else
            ApplicationService.GenerateError("El Estado Pago {0} no existe.", Quoted(PrimaryKey(0)))
        End If
    End Sub
...
#Region "Constructor"
    ...
    Private Const cnEntidad As String = "tbMaestroEstadoPago"
...
#Region "Eventos RegisterValidateTasks"
    ...
    <Task()> Public Shared Sub ValidarClaveDuplicada(ByVal data As DataRow, ByVal services As ServiceProvider)
        If data.RowState = DataRowState.Added Then
            Dim dtObjeto As DataTable = New EstadoPago().SelOnPrimaryKey(data("IDEstado"))
...
#Region "Funciones Públicas"
    ...
    <Task()> Public Shared Function EstadosPagosAgrupables(ByVal data As Object, ByVal services As ServiceProvider) As DataTable
        Return New EstadoPago().Filter(New FilterItem("Desagrupable", FilterOperator.Equal, True, FilterType.Boolean))
    End Function
