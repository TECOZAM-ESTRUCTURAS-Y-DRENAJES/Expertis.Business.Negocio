...
#Region "Constructor"
    ...
    Private Const cnEntidad As String = "tbMaestroTipoProveedor"
...
#Region "Eventos RegisterValidateTasks"
    ...
    <Task()> Public Shared Sub ValidarDatosObligatorios(ByVal data As DataRow, ByVal services As ServiceProvider)
        If Length(data("IDTipoProveedor")) = 0 Then ApplicationService.GenerateError("Tipo Proveedor es un dato obligatorio.")
        If Length(data("DescTipoProveedor")) = 0 Then ApplicationService.GenerateError("La Descripción es un dato obligatorio.")
    End Sub
    ...
    <Task()> Public Shared Sub ValidarClavePrimaria(ByVal data As DataRow, ByVal services As ServiceProvider)
        If data.RowState = DataRowState.Added Then
            Dim dt As DataTable = New TipoProveedor().SelOnPrimaryKey(data("IDTipoProveedor"))
