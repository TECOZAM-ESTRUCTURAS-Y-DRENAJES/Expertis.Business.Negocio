Public Class AlbaranVentaRepresentante
    Inherits Solmicro.Expertis.Engine.BE.BusinessHelper
    Public Sub New()
        MyBase.New(cnEntidad)
    End Sub

    Private Const cnEntidad As String = "tbAlbaranVentaRepresentante"
...
#Region " Validate "
    ...
    <Task()> Public Shared Sub ValidarRegistroExistente(ByVal data As DataRow, ByVal services As ServiceProvider)
        If data.RowState = DataRowState.Added Then
            Dim dtAVR As DataTable = New AlbaranVentaRepresentante().SelOnPrimaryKey(data("IDLineaAlbaran"), data("IDRepresentante"))
            If Not dtAVR Is Nothing AndAlso dtAVR.Rows.Count > 0 Then
