Public Class HistoricoPreciosProveedorQDesde
...
#Region "Constructor"
    ...
    Private Const cnEntidad As String = "tbHistoricoPreciosProveedorQDesde"
...
#Region "Eventos Entidad"
    ...
    <Task()> Public Shared Sub ValidarClaveDuplicada(ByVal data As DataRow, ByVal services As ServiceProvider)
        If data.RowState = DataRowState.Added Then
            ...
            Dim DtHist As DataTable = New HistoricoPreciosProveedorQDesde().Filter(FilHist)
            If Not DtHist Is Nothing AndAlso DtHist.Rows.Count > 0 Then
                ApplicationService.GenerateError("El histórico introducido para la cantidad y fechas introducidas ya existe en el histórico.")
            End If
        End If
    End Sub
