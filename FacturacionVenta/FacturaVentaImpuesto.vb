...
#Region " Constructor "
    ...
    Private Const cnEntidad As String = "tbFacturaVentaImpuesto"
...
#Region " RegisterValidateTaks "
    ...
    <Task()> Public Shared Sub ValidarDatosObligatorios(ByVal data As DataRow, ByVal services As ServiceProvider)
        If Length(data("IDFactura")) = 0 Then ApplicationService.GenerateError("No se ha indicado el Identificador de la lFactura.")
    ...
    <Task()> Public Shared Sub ValidarRegistroExistente(ByVal data As DataRow, ByVal services As ServiceProvider)
        If data.RowState = DataRowState.Added Then
            ...
            Dim dt As DataTable = New FacturaVentaImpuesto().Filter(f)
