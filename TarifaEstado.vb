...
#Region "Eventos RegisterValidateTasks"
    ...
    <Task()> Public Shared Sub ValidarDatosObligatorios(ByVal data As DataRow, ByVal services As ServiceProvider)
        If Length(data("IDEstado")) = 0 Then ApplicationService.GenerateError("El código de estado es obligatorio.")
        If Length(data("DescEstado")) = 0 Then ApplicationService.GenerateError("La descripción es obligatoria.")
    End Sub
